...
public class EntityHider implements Listener {
    private static final Integer ENTITY_EQUIPMENT = null;

	private static final Integer ENTITY_LOCATION_ACTION = null;

	private static final Integer ARM_ANIMATION = null;

	private static final Integer NAMED_ENTITY_SPAWN = null;

	private static final Integer COLLECT = null;

	private static final Integer VEHICLE_SPAWN = null;

	private static final Integer MOB_SPAWN = null;

	private static final Integer ENTITY_PAINTING = null;

	private static final Integer ADD_EXP_ORB = null;

	private static final Integer ENTITY_VELOCITY = null;

	private static final Integer REL_ENTITY_MOVE = null;

	private static final Integer ENTITY_LOOK = null;

	private static final Integer REL_ENTITY_MOVE_LOOK = null;

	private static final Integer ENTITY_TELEPORT = null;

	private static final Integer ENTITY_HEAD_ROTATION = null;

	private static final Integer ENTITY_STATUS = null;

	private static final Integer ATTACH_ENTITY = null;

	private static final Integer ENTITY_METADATA = null;

	private static final Integer MOB_EFFECT = null;

	private static final Integer REMOVE_MOB_EFFECT = null;

	private static final Integer BLOCK_BREAK_ANIMATION = null;
	...
	private static final PacketType DESTROY_ENTITY = null;
